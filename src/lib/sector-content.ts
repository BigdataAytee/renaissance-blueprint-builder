...
export const sectorContent: Record<string, SectorContent> = {
  "project-property-management": {
    ...
    overviewParagraphs: [
      "Dynamic Renaissance provides end-to-end project and property management services for public, institutional and private clients pursuing complex capital projects. Our teams bring together architects, engineers, project managers, quantity surveyors and facility specialists under a single accountable delivery model.",
      "We take clients from concept and feasibility through design coordination, construction management and operational handover — supported by disciplined cost, schedule, quality and safety controls. After completion, our facility management practice keeps assets performing at peak efficiency over their entire lifecycle.",
      "Our competitive advantage is integration: one experienced partner across planning, delivery and operations, aligned to your commercial goals and answerable for outcomes rather than tasks.",
    ],
    expertise: [
      "Feasibility studies and development advisory",
      "Design coordination and engineering consultancy",
      "Construction management and general contracting",
      "Cost planning, tendering and commercial controls",
      "Health, safety and environmental leadership",
      "Facility management and asset performance",
    ],
    stats: [
    ...
    services: [
      { icon: ClipboardCheck, name: "Project Planning", description: "Strategic planning, feasibility studies and delivery roadmaps that de-risk complex capital projects from day one.", benefits: ["Clear scope and objectives", "Realistic budgets and timelines", "Early risk identification"], industries: ["Government", "Real Estate", "Corporate Organisations"] },
      { icon: HardHat, name: "Construction Management", description: "Turn-key construction management for commercial, residential, institutional and industrial developments.", benefits: ["Single point of accountability", "Rigorous cost & schedule control", "HSE-led execution"], industries: ["Real Estate", "Infrastructure", "Manufacturing"] },
      { icon: Building, name: "Infrastructure Development", description: "Delivery of civil infrastructure programmes including roads, utilities, industrial parks and public facilities.", benefits: ["Complex stakeholder coordination", "Engineering depth", "Community impact planning"], industries: ["Government", "Infrastructure", "Energy"] },
      { icon: Home, name: "Property Management", description: "Full-service property management for commercial and mixed-use portfolios covering tenancy, revenue and asset care.", benefits: ["Higher occupancy", "Optimised rental yield", "Preserved asset value"], industries: ["Real Estate", "Corporate Organisations", "Financial Institutions"] },
      { icon: Wrench, name: "Facility Management", description: "Hard and soft facility services keeping buildings safe, efficient and pleasant to occupy.", benefits: ["Lower operating cost", "Reliable building systems", "Excellent occupant experience"], industries: ["Corporate Organisations", "Healthcare", "Education"] },
      { icon: Ruler, name: "Engineering Consultancy", description: "Multidisciplinary engineering advisory covering civil, structural, MEP and specialist systems.", benefits: ["Independent expert advice", "Optimised design solutions", "Compliance assurance"], industries: ["Infrastructure", "Manufacturing", "Government"] },
      { icon: Cog, name: "General Contracting", description: "Coordinated main-contractor delivery for renovations, fit-outs and greenfield developments.", benefits: ["Reliable subcontractor management", "Predictable outcomes", "Warranty-backed workmanship"], industries: ["Real Estate", "Hospitality", "Retail"] },
      { icon: Handshake, name: "Maintenance Services", description: "Planned and reactive maintenance programmes that extend asset life and reduce disruption.", benefits: ["Reduced downtime", "Longer asset life", "Predictable maintenance cost"], industries: ["Corporate Organisations", "Infrastructure", "Healthcare"] },
    ],
    equipment: [
  ...
  "oil-and-gas": {
    ...
    overviewParagraphs: [
      "Dynamic Renaissance provides integrated oil and gas services spanning petroleum marketing, fuel distribution, LPG supply, pipeline support, storage operations and specialist maintenance. Our teams operate under strict HSE governance and comply with all applicable industry and regulatory standards.",
      "We support Independent Marketing Companies (IMCs), industrial off-takers, government agencies and large corporate consumers with reliable product movement, technical services and commercial energy solutions. Our national distribution network and vetted partner ecosystem ensure consistent uptime and product availability.",
      "Whether you need bulk fuel supply for a fleet, LPG for hospitality operations, technical support on a depot upgrade or advisory on downstream commercial strategy, we bring proven operational capability and trusted commercial discipline.",
    ],
    expertise: [
      "Petroleum products marketing and distribution",
      "Bulk fuel and LPG supply to industry",
      "Depot, terminal and storage support",
      "Pipeline inspection and maintenance",
      "Downstream and industrial energy consulting",
      "Emergency response and HSE-led operations",
    ],
    stats: [
    ...
    services: [
      { icon: Fuel, name: "Petroleum Marketing", description: "Reliable supply of PMS, AGO, DPK, ATK and lubricants to commercial, industrial and institutional customers.", benefits: ["Consistent product availability", "Competitive pricing", "Fully compliant deliveries"], industries: ["Transportation", "Manufacturing", "Government"] },
      { icon: TruckIcon, name: "Fuel Distribution", description: "Nationwide bulk fuel distribution operated with dedicated tankers, tracked deliveries and safety-first drivers.", benefits: ["Reliable route-to-site", "Full delivery traceability", "Compliant tanker fleet"], industries: ["Oil & Gas", "Transportation", "Construction"] },
      { icon: Pipette, name: "Pipeline Support", description: "Field support for pipeline operations including inspection coordination, maintenance and integrity monitoring.", benefits: ["Reduced downtime", "Improved integrity assurance", "Skilled field crews"], industries: ["Oil & Gas", "Energy"] },
      { icon: Warehouse, name: "Storage Facilities", description: "Depot and terminal operational support covering safe handling, loading and product movement.", benefits: ["Safer product movement", "Loss-control discipline", "Certified operators"], industries: ["Oil & Gas", "Energy", "Government"] },
      { icon: Flame, name: "Gas Supply", description: "Reliable industrial and commercial gas supply agreements structured around customer offtake profiles.", benefits: ["Predictable supply", "Flexible offtake terms", "Technical support"], industries: ["Manufacturing", "Hospitality", "Energy"] },
      { icon: Droplets, name: "LPG Distribution", description: "LPG supply to hospitality operators, industrial users and household distributors nationwide.", benefits: ["Cleaner energy option", "Reliable refills", "Cylinder & bulk options"], industries: ["Hospitality", "SMEs", "Manufacturing"] },
      { icon: Wrench, name: "Maintenance Services", description: "Preventive and corrective maintenance for downstream assets, generators and energy equipment.", benefits: ["Improved uptime", "Longer asset life", "Predictable maintenance cost"], industries: ["Oil & Gas", "Manufacturing", "Corporate Organisations"] },
      { icon: LineChart, name: "Energy Consulting", description: "Commercial and technical advisory on procurement strategy, energy transition and downstream operations.", benefits: ["Lower total energy cost", "Better supply resilience", "Transition-ready strategy"], industries: ["Corporate Organisations", "Government", "Energy"] },
      { icon: Zap, name: "Industrial Energy Solutions", description: "Bundled fuel, generator and energy management solutions for large industrial consumers.", benefits: ["Simplified vendor management", "Better cost visibility", "Guaranteed availability"], industries: ["Manufacturing", "Healthcare", "Financial Institutions"] },
    ],
    equipment: [
  ...
  agriculture: {
    ...
    overviewParagraphs: [
      "Our agriculture practice spans commercial crop production, poultry, livestock, agro-processing, fertiliser distribution, mechanised equipment supply and agricultural consulting. We work directly with land owners, off-takers, cooperatives, agencies and consortia to build productive, resilient and sustainable food systems.",
      "By combining professional farm management, modern mechanisation, agronomic best practice and integrated logistics, we help clients raise yields, reduce post-harvest losses and improve market access for their produce. Our programmes are designed for scale, traceability and long-term profitability.",
      "We are committed to sustainable agriculture — protecting soil health, using water responsibly and creating meaningful economic opportunity across rural value chains.",
    ],
    expertise: [
      "Mechanised commercial farming",
      "Poultry and livestock operations",
      "Agro-processing and value addition",
      "Fertiliser and input distribution",
    ...
    services: [
      { icon: Sprout, name: "Commercial Farming", description: "Large-scale grain, tuber and cash-crop production run to professional agronomic and commercial standards.", benefits: ["Higher yields per hectare", "Consistent quality", "Predictable off-take"], industries: ["Agriculture", "Food Processing", "Government"] },
      { icon: Tractor, name: "Mechanised Farming", description: "Full mechanisation services covering land preparation, planting, spraying and harvesting.", benefits: ["Faster field operations", "Lower labour dependency", "Reduced production cost"], industries: ["Agriculture", "SMEs", "Government"] },
      { icon: Sprout, name: "Crop Production", description: "Agronomy-led production programmes for staple, industrial and export-oriented crops.", benefits: ["Optimised input use", "Better crop protection", "Traceable produce"], industries: ["Food Processing", "Agriculture", "SMEs"] },
      { icon: Egg, name: "Poultry", description: "Modern poultry operations covering broilers, layers and processing under strict biosecurity controls.", benefits: ["Consistent bird performance", "Food-safe processing", "Reliable supply to buyers"], industries: ["Food Processing", "Hospitality", "Retail"] },
      { icon: Beef, name: "Livestock", description: "Livestock rearing, feedlot management and processing coordination for local and regional markets.", benefits: ["Improved animal welfare", "Better weight gain", "Structured off-take"], industries: ["Food Processing", "Hospitality", "Government"] },
      { icon: Package, name: "Agro Processing", description: "Value-addition through cleaning, milling, packaging and processing of primary produce.", benefits: ["Higher margins", "Extended shelf life", "Market-ready products"], industries: ["Food Processing", "Retail", "Manufacturing"] },
      { icon: SprayCan, name: "Fertilizer Distribution", description: "Distribution of high-grade fertilisers, agrochemicals and inputs to farmers and cooperatives.", benefits: ["Timely input supply", "Quality-assured products", "Agronomic guidance"], industries: ["Agriculture", "Government", "SMEs"] },
      { icon: Tractor, name: "Agricultural Equipment", description: "Supply, hire and maintenance of tractors, implements and post-harvest equipment.", benefits: ["Access to modern equipment", "Reduced ownership burden", "Trained operators"], industries: ["Agriculture", "SMEs", "Government"] },
      { icon: Briefcase, name: "Agro Consulting", description: "Advisory on agribusiness investment, farm planning, off-take structuring and sustainability strategy.", benefits: ["Better investment decisions", "Structured off-take deals", "Bankable business plans"], industries: ["Financial Institutions", "Government", "Corporate Organisations"] },
    ],
    equipment: [
  ...
  "logistics-distribution": {
    ...
    overviewParagraphs: [
      "Our logistics and distribution practice supports FMCG groups, industrial manufacturers, agro-processors, retailers and public agencies with dependable haulage, warehousing, procurement and last-mile execution. We operate a modern fleet, run structured route management and deliver against clear service-level commitments.",
      "We combine tracked vehicles, professional drivers, disciplined warehouse operations and integrated procurement services to give clients a single logistics partner they can rely on. Our operations are supported by digital planning tools, GPS visibility and rigorous safety standards.",
      "Whether you need cross-country freight, national warehouse cover, import-export coordination or dedicated last-mile fleets, we design the right operating model and execute it consistently.",
    ],
    expertise: [
      "Primary haulage and long-haul freight",
      "Warehousing and cross-dock operations",
      "Fleet management and asset-based logistics",
      "Procurement and supply chain services",
      "Import/export coordination and freight forwarding",
    ...
    services: [
      { icon: TruckIcon, name: "Fleet Management", description: "Operation, servicing and asset management of commercial fleets for company or client accounts.", benefits: ["Higher fleet uptime", "Predictable operating cost", "Certified drivers"], industries: ["Manufacturing", "Retail", "Oil & Gas"] },
      { icon: TruckIcon, name: "Haulage", description: "Long-haul freight, tanker services and specialised heavy haulage across the country.", benefits: ["National coverage", "Compliant vehicles", "Real-time tracking"], industries: ["Manufacturing", "Oil & Gas", "Construction"] },
      { icon: Warehouse, name: "Warehousing", description: "Ambient, secured and cross-dock warehousing with racking, inventory management and access control.", benefits: ["Better stock visibility", "Reduced shrinkage", "Efficient inbound/outbound flow"], industries: ["Retail", "FMCG", "Healthcare"] },
      { icon: Boxes, name: "Supply Chain", description: "End-to-end supply chain design and execution covering sourcing, movement and delivery.", benefits: ["Lower total cost to serve", "Better SLA performance", "Simplified vendor management"], industries: ["Manufacturing", "Retail", "Corporate Organisations"] },
      { icon: PackageOpen, name: "Procurement", description: "Structured procurement of goods and services with vetted supplier networks and compliance controls.", benefits: ["Better pricing outcomes", "Compliant sourcing", "Faster time-to-supply"], industries: ["Government", "Corporate Organisations", "Healthcare"] },
      { icon: Ship, name: "Import & Export", description: "Freight forwarding, customs coordination and international movement across sea, air and land.", benefits: ["Reduced clearance time", "Compliant documentation", "Multi-modal options"], industries: ["Manufacturing", "Retail", "SMEs"] },
      { icon: Container, name: "Freight Services", description: "Container handling, transfers and specialised freight movement for industrial and commercial clients.", benefits: ["Reliable schedules", "Damage-free handling", "Coordinated logistics"], industries: ["Manufacturing", "Oil & Gas", "Construction"] },
      { icon: Boxes, name: "Distribution", description: "Structured distribution networks moving goods from production sites to regional depots and retail points.", benefits: ["Faster route-to-market", "Consistent service levels", "Full traceability"], industries: ["Retail", "FMCG", "Healthcare"] },
      { icon: Send, name: "Last-mile Delivery", description: "Dedicated last-mile fleets and rider networks handling final delivery to customers.", benefits: ["Same-day / next-day options", "Proof-of-delivery capture", "Higher customer satisfaction"], industries: ["Retail", "Healthcare", "SMEs"] },
    ],
    equipment: [
