...
export const serviceSlideshows: Record<string, Record<string, string[]>> = {
  "project-property-management": {
    "Project Planning & Feasibility": ["blueprint", "architect", "engineer", "construction"],
    "Construction Management": ["crane", "construction", "scaffolding", "highrise"],
    "Civil Engineering & Infrastructure": ["bridge", "highway", "roadwork", "hospital"],
    "Property Development & Estate Management": ["apartment", "estate", "house", "skyline"],
    "Facility Management": ["office", "lobby", "mall", "building"],
    "Architectural Design & Engineering Consultancy": ["architecture", "blueprint", "cad", "skyscraper"],
    "General Contracting & Renovation": ["renovation", "interior", "carpenter", "painter"],
    "Maintenance Services": ["repair", "electrician", "plumber", "handyman"],
  },
  "oil-and-gas": {
    "Petroleum Marketing": ["petrol", "gasstation", "pump", "aviation"],
    "Fuel Distribution": ["tanker", "truck", "diesel", "fuel"],
    "Pipeline & EPC Support": ["pipeline", "pipe", "welding", "oilfield"],
    "Storage Tanks & Terminals": ["storagetank", "refinery", "depot", "terminal"],
    "LNG & Industrial Gas Supply": ["lng", "gasplant", "refinery", "industry"],
    "LPG Distribution": ["cylinder", "propane", "gas", "cooking"],
    "Maintenance & Inspection": ["oilworker", "hardhat", "inspection", "pipeline"],
    "Offshore & Marine Logistics": ["offshore", "rig", "platform", "drilling"],
    "Safety Systems & Industrial Energy": ["controlroom", "safety", "helmet", "firefighter"],
  },
  agriculture: {
    "Commercial Crop Production": ["cocoa", "rice", "maize", "sorghum", "cassava", "soybean"],
    "Mechanised & Irrigation Farming": ["tractor", "harvester", "irrigation", "greenhouse"],
    "Palm Oil, Rubber & Ginger Value Chains": ["palm", "rubber", "ginger", "sesame"],
    "Poultry & Fish Farming": ["chicken", "poultry", "fish", "aquaculture"],
    Livestock: ["cattle", "cow", "goat", "sheep"],
    "Agro-Processing, Storage & Packaging": ["silo", "grain", "packaging", "warehouse"],
    "Fertilizers, Seeds & Agrochemicals": ["fertilizer", "seeds", "spraying", "pesticide"],
    "Agricultural Equipment": ["tractor", "harvester", "greenhouse", "combine"],
    "Commodity Export & Advisory": ["cocoa", "cashew", "coffee", "port"],
  },
  "logistics-distribution": {
    "Fleet Management": ["truck", "van", "fleet", "lorry"],
    "Trucking & Haulage": ["truck", "highway", "tanker", "lorry"],
    "Warehousing & Inventory Management": ["warehouse", "forklift", "pallet", "racking"],
    "Supply Chain Management": ["logistics", "container", "shipping", "warehouse"],
    "Cold Chain Logistics": ["refrigerated", "reefer", "coldstorage", "pharmacy"],
    "Freight Forwarding & Customs Clearance": ["cargoship", "port", "customs", "aircargo"],
    "Container Transport & Cargo Handling": ["container", "port", "crane", "shipping"],
    "Distribution Networks": ["warehouse", "delivery", "truck", "loading"],
    "Last-Mile Delivery": ["courier", "delivery", "motorcycle", "parcel"],
  },
  "manufacturing-trading": {
    "Industrial Manufacturing": ["factory", "production", "assembly", "industry"],
    "Wholesale Trading": ["warehouse", "cement", "steel", "wholesale"],
    "Retail Distribution": ["supermarket", "shelves", "hardware", "store"],
    "Consumer Products": ["supermarket", "packaging", "shelves", "grocery"],
    "Industrial Products & Spare Parts": ["engineoil", "filter", "bearing", "sparepart"],
    "Building Materials Distribution": ["cement", "steel", "roofing", "paint"],
    "Procurement & Sourcing": ["cargo", "machinery", "port", "shipping"],
    "Supply Chain": ["warehouse", "logistics", "factory", "container"],
  },
  "industrial-services": {
    "Industrial Cleaning & Sandblasting": ["sandblasting", "cleaning", "pressurewash", "tank"],
    "Equipment Installation & Supply": ["engineer", "machinery", "factory", "installation"],
    "Corrosion Protection & Coatings": ["pipeline", "coating", "painting", "corrosion"],
    "Fabrication, Welding & Mechanical Repairs": ["welding", "welder", "fabrication", "workshop"],
    "Preventive Maintenance & Shutdown Services": ["maintenance", "turbine", "factory", "engineer"],
    "Heavy Equipment Servicing": ["generator", "forklift", "compressor", "excavator"],
  },
  "hospitality-entertainment": {
    "Hotels & Resorts": ["hotel", "resort", "lobby", "pool"],
    Restaurants: ["restaurant", "dining", "chef", "cuisine"],
    "Catering & Banqueting": ["banquet", "catering", "buffet", "wedding"],
    "Corporate Events & Wedding Venues": ["wedding", "ballroom", "gala", "event"],
    "Conference Centres": ["conference", "auditorium", "meeting", "convention"],
    "Fast Food & QSR": ["fastfood", "burger", "cafe", "counter"],
    "Recreation & Tourism Services": ["tourism", "resort", "spa", "leisure"],
    Beverages: ["cocktail", "bar", "wine", "bartender"],
  },
  "business-consultancy": {
    "Business Strategy & Feasibility Studies": ["meeting", "office", "whiteboard", "boardroom"],
    "Financial & Investment Advisory": ["finance", "stockmarket", "chart", "trading"],
    "Corporate Advisory & Risk Management": ["boardroom", "executive", "meeting", "corporate"],
    "Marketing & Market Research": ["marketing", "advertising", "brand", "research"],
    "Project Advisory & Business Development": ["handshake", "meeting", "partnership", "office"],
    "Corporate Training & HR Consulting": ["training", "seminar", "workshop", "classroom"],
    "Procurement Consulting & Operations Support": ["office", "team", "meeting", "workflow"],
    "Digital & Business Transformation": ["technology", "computer", "dashboard", "digital"],
  },
};
...
export const sectorContent: Record<string, SectorContent> = {
  ...
  "manufacturing-trading": {
    ...
    overviewParagraphs: [
      "Dynamic Renaissance operates and partners with manufacturing lines and trading houses supplying industrial lubricants (engine oil, hydraulic oil, grease), industrial filters (air, oil and fuel filters), bearings, fasteners, pipes, valves, pumps, electrical cables, welding consumables and safety equipment — alongside building materials such as cement, steel products, roofing materials, paints and packaging materials.",
      "Our trading arm sources reliably and distributes efficiently through wholesale and retail channels — covering forklift spare parts, generator spare parts, industrial machinery, mechanical and electrical components, industrial tools and chemicals. Clients benefit from consistent products, reliable availability and flexible commercial arrangements, from bulk supply agreements to structured distributorship programmes.",
      "Whether you are looking for a manufacturing partner, an industrial supplier of pipes and valves for a plant, cement and steel for a construction site, or a nationwide distributor for consumer goods, we bring the operational capability and commercial trust to deliver.",
    ],
    expertise: [
      "Industrial lubricants: engine oil, hydraulic oil, grease",
      "Filters (air, oil, fuel), bearings, fasteners and industrial tools",
      "Pipes, valves, pumps, welding consumables and safety equipment",
      "Electrical cables, mechanical and electrical components",
      "Building materials: cement, steel, roofing, paints, chemicals, packaging",
      "Forklift, generator and industrial machinery spare parts",
    ],
    stats: [
    ...
    services: [
      { icon: Factory, name: "Industrial Manufacturing", description: "Own and partner manufacturing operations producing industrial lubricants, packaging materials, chemicals and finished products for consumer, industrial and commercial markets.", benefits: ["Consistent product quality", "Reliable production capacity", "Compliant operations"], industries: ["Manufacturing", "Retail", "Corporate Organisations"] },
      { icon: Store, name: "Wholesale Trading", description: "Structured wholesale supply of cement, steel products, roofing materials, paints, cables, pipes and valves to distributors, contractors and large retail customers.", benefits: ["Bulk pricing", "Reliable stock availability", "Category depth"], industries: ["Retail", "SMEs", "Corporate Organisations"] },
      { icon: ShoppingBag, name: "Retail Distribution", description: "Retail-facing distribution partnerships that place consumer products, hardware and building materials in modern trade and traditional trade outlets.", benefits: ["Wide market reach", "Merchandising support", "Faster stock turn"], industries: ["Retail", "SMEs", "Corporate Organisations"] },
      { icon: ShoppingCart, name: "Consumer Products", description: "Distribution of fast-moving consumer goods and packaged products through structured route-to-market plans and regional depots.", benefits: ["High availability", "Strong shelf presence", "Consumer trust"], industries: ["Retail", "FMCG", "SMEs"] },
      { icon: Layers, name: "Industrial Products & Spare Parts", description: "Supply of engine oil, hydraulic oil, grease, air/oil/fuel filters, bearings, fasteners, welding consumables, safety equipment, forklift and generator spare parts to plants and operators.", benefits: ["Reduced downtime", "Technical support", "Reliable sourcing"], industries: ["Manufacturing", "Oil & Gas", "Construction"] },
      { icon: Boxes, name: "Building Materials Distribution", description: "End-to-end distribution of cement, steel, roofing sheets, paints, packaging materials and chemicals — combining warehousing, logistics and channel management.", benefits: ["Faster route-to-market", "Full traceability", "Structured KPI reporting"], industries: ["Construction", "Retail", "Manufacturing"] },
      { icon: PackageOpen, name: "Procurement & Sourcing", description: "Sourcing of raw materials, industrial machinery, mechanical and electrical components and specialised goods through vetted local and international supplier networks.", benefits: ["Better commercial terms", "Compliant sourcing", "Reduced supply risk"], industries: ["Manufacturing", "Government", "Corporate Organisations"] },
      { icon: Boxes, name: "Supply Chain", description: "Integrated supply chain design, execution and management for manufacturers and traders — from inbound raw materials to outbound finished-goods distribution.", benefits: ["Lower total supply-chain cost", "Improved service levels", "Better inventory control"], industries: ["Manufacturing", "Retail", "FMCG"] },
    ],
    equipment: [
  ...
  "industrial-services": {
    ...
    overviewParagraphs: [
      "Our industrial services practice supports factories, oil and gas facilities, hospitals, hospitality operators and commercial complexes with equipment installation, plant maintenance, fabrication, welding, mechanical repairs, electrical maintenance, industrial cleaning and heavy equipment servicing.",
      "We combine trained technicians, appropriate PPE, sector-specific SOPs and modern equipment to deliver preventive maintenance, shutdown services, equipment inspection, corrosion protection, sandblasting and protective coatings safely — with a strong record on hazardous environments, sensitive spaces and high-uptime operations.",
      "Clients rely on us to reduce downtime, extend asset life, comply with strict industry standards and free their teams to focus on core operations while we handle the technical support behind the scenes.",
    ],
    expertise: [
      "Equipment installation and plant maintenance",
      "Fabrication, welding and mechanical repairs",
      "Electrical maintenance and preventive maintenance",
      "Shutdown services and equipment inspection",
      "Corrosion protection, sandblasting and protective coatings",
      "Industrial cleaning and heavy equipment servicing",
    ],
    stats: [
    ...
    services: [
      { icon: SprayCan, name: "Industrial Cleaning & Sandblasting", description: "Deep cleaning, high-pressure cleaning, tank cleaning, sandblasting and specialist decontamination services across plants, tanks, pipelines and processing facilities.", benefits: ["Safer working environments", "Improved plant hygiene", "Compliant waste handling"], industries: ["Manufacturing", "Oil & Gas", "Healthcare"] },
      { icon: PackageOpen, name: "Equipment Installation & Supply", description: "Installation, commissioning and supply of industrial equipment, tools, spare parts and consumables for plant and facility operators.", benefits: ["Reliable spares availability", "Technical selection support", "Warranty-backed products"], industries: ["Manufacturing", "Oil & Gas", "Construction"] },
      { icon: Beaker, name: "Corrosion Protection & Coatings", description: "Application of protective coatings, anti-corrosion systems and specialist chemicals for tanks, pipelines, structural steel and offshore assets.", benefits: ["Extended asset life", "Compliant application", "Documented QA/QC"], industries: ["Oil & Gas", "Manufacturing", "Marine"] },
      { icon: Hammer, name: "Fabrication, Welding & Mechanical Repairs", description: "On-site and workshop fabrication, welding and mechanical repair services for pumps, motors, gearboxes, piping and structural components.", benefits: ["Faster return-to-service", "Extended equipment life", "Cost-effective refurbishment"], industries: ["Manufacturing", "Oil & Gas", "Energy"] },
      { icon: Settings, name: "Preventive Maintenance & Shutdown Services", description: "Planned preventive, condition-based and turnaround maintenance — including shutdown services, equipment inspection and electrical maintenance for industrial assets and building systems.", benefits: ["Reduced unplanned downtime", "Better asset performance", "Predictable maintenance spend"], industries: ["Manufacturing", "Oil & Gas", "Healthcare"] },
      { icon: SprayCan, name: "Heavy Equipment Servicing", description: "Servicing and overhaul of heavy equipment — generators, forklifts, compressors and industrial machinery — plus facility-wide janitorial programmes for corporate and hospitality clients.", benefits: ["Cleaner workplaces", "Higher occupant satisfaction", "Managed vendor accountability"], industries: ["Corporate Organisations", "Hospitality", "Education"] },
    ],
    equipment: [
  ...
  "hospitality-entertainment": {
    ...
    overviewParagraphs: [
      "Dynamic Renaissance operates and partners across the hospitality and entertainment value chain — from full-service hotels and resorts to premium restaurants, catering, banqueting, conference centres, event venues, wedding venues, recreation facilities and tourism services. Our service culture is built on hospitality excellence, guest empathy and operational discipline.",
      "We combine trained hospitality professionals, refined service standards and modern operational systems to deliver reliably exceptional guest accommodation and corporate events at scale. Our facilities meet the expectations of corporate, government, institutional and private clients hosting important functions.",
      "Whether you are planning a landmark conference, a signature dining experience, a wedding at one of our event venues, or a long-stay hospitality partnership, we bring the venues, the talent and the operational rigour to deliver memorable outcomes.",
    ],
    expertise: [
      "Hotels, resorts and premium guest accommodation",
      "Restaurants, catering and banqueting",
      "Conference centres and event venues",
      "Corporate events and wedding venues",
      "Recreation facilities and tourism services",
      "Hospitality advisory and operational set-up",
    ],
    stats: [
    ...
    services: [
      { icon: Hotel, name: "Hotels & Resorts", description: "Full-service hotel and resort operations covering guest accommodation, F&B, wellness and end-to-end guest experience.", benefits: ["Consistent guest experience", "Optimised occupancy", "Strong reputation"], industries: ["Hospitality", "Corporate Organisations", "Government"] },
      { icon: UtensilsCrossed, name: "Restaurants", description: "Signature dining venues offering curated menus, refined service and memorable atmospheres — from fine dining to all-day dining.", benefits: ["Elevated culinary experience", "Trained service teams", "Modern venue design"], industries: ["Hospitality", "Corporate Organisations", "Retail"] },
      { icon: ChefHat, name: "Catering & Banqueting", description: "Corporate, institutional and event catering with structured menu planning, banqueting service and hygiene controls for weddings, conferences and government functions.", benefits: ["Reliable large-scale service", "Food-safety compliance", "Flexible menu options"], industries: ["Corporate Organisations", "Government", "Education"] },
      { icon: CalendarDays, name: "Corporate Events & Wedding Venues", description: "Full-service event management and dedicated wedding venues for corporate events, conferences, weddings and public functions.", benefits: ["Turn-key event delivery", "Vendor coordination", "Guest-centric planning"], industries: ["Corporate Organisations", "Government", "NGOs"] },
      { icon: Mic, name: "Conference Centres", description: "Modern conference centres and meeting facilities with integrated AV, catering and hospitality support for MICE clients.", benefits: ["Professional venues", "Integrated AV", "Full delegate support"], industries: ["Corporate Organisations", "Government", "Education"] },
      { icon: Coffee, name: "Fast Food & QSR", description: "Quick-service outlets delivering fresh, consistent and affordable meals across busy urban and travel locations.", benefits: ["Fast service", "Consistent quality", "Convenient locations"], industries: ["Retail", "SMEs", "Corporate Organisations"] },
      { icon: Mic, name: "Recreation & Tourism Services", description: "Curated recreation facilities, entertainment venues and tourism services — leisure resorts, guided experiences and lifestyle programming.", benefits: ["Signature experiences", "Corporate & private hire", "Curated programming"], industries: ["Hospitality", "Corporate Organisations", "Retail"] },
      { icon: Coffee, name: "Beverages", description: "Beverage distribution, bar operations and specialty beverage services for events, hotels and restaurants.", benefits: ["Reliable beverage supply", "Trained bar teams", "Wide beverage portfolio"], industries: ["Hospitality", "Retail", "Corporate Organisations"] },
    ],
    equipment: [
  ...
  "business-consultancy": {
    ...
    overviewParagraphs: [
      "Our consultancy practice supports government bodies, corporates, financial institutions and SMEs with business strategy, financial advisory, project advisory, human resources consulting, procurement consulting, business transformation and digital transformation. We combine sector insight with executional discipline.",
      "Our consultants bring deep on-the-ground experience — many drawn from our operating businesses — which means our advice on risk management, compliance, corporate training, market research, investment advisory and feasibility studies is practical, tested and grounded in commercial reality. We don't just recommend; we help clients implement, measure and sustain change.",
      "Whether you are preparing a feasibility study for a new plant, structuring investment advisory for a fund, building a business plan for market entry, running a corporate training programme, or digitising core processes, we bring the frameworks, the specialists and the delivery muscle to move you forward.",
    ],
    expertise: [
      "Business strategy, feasibility studies and business planning",
      "Financial advisory, investment advisory and project advisory",
      "Human resources consulting and procurement consulting",
      "Business transformation and digital transformation",
      "Risk management, compliance and corporate training",
    ...
    services: [
      { icon: Briefcase, name: "Business Strategy & Feasibility Studies", description: "Structured problem-solving, business planning and feasibility studies across strategy, operations and organisational design for new ventures and existing businesses.", benefits: ["Sharper strategic focus", "Better decisions", "Actionable roadmaps"], industries: ["Corporate Organisations", "Government", "Financial Institutions"] },
      { icon: TrendingUp, name: "Financial & Investment Advisory", description: "Financial advisory, investment advisory and portfolio strategy grounded in market research, competitive analysis and internal capability — including bankable financial models.", benefits: ["Clear direction", "Prioritised initiatives", "Investor-ready narrative"], industries: ["Corporate Organisations", "Financial Institutions", "SMEs"] },
      { icon: UsersRound, name: "Corporate Advisory & Risk Management", description: "Board-level corporate advisory covering governance, business transformation, restructuring, risk management, compliance and stakeholder engagement.", benefits: ["Stronger governance", "Confident boards", "Structured transformation"], industries: ["Corporate Organisations", "Government", "Financial Institutions"] },
      { icon: Megaphone, name: "Marketing & Market Research", description: "Brand strategy, marketing planning, market research and campaign design across traditional and digital media — grounded in consumer and B2B insight.", benefits: ["Stronger brand equity", "Better campaign ROI", "Integrated channel mix"], industries: ["Retail", "SMEs", "Corporate Organisations"] },
      { icon: Rocket, name: "Project Advisory & Business Development", description: "Project advisory, market entry, deal origination, partnerships and channel expansion support for growth-stage organisations.", benefits: ["Faster market entry", "Structured partnerships", "New revenue channels"], industries: ["SMEs", "Corporate Organisations", "Financial Institutions"] },
      { icon: GraduationCap, name: "Corporate Training & HR Consulting", description: "Executive training, technical skills programmes, human resources consulting and leadership development for teams and organisations.", benefits: ["Stronger capability", "Better retention", "Structured development"], industries: ["Corporate Organisations", "Government", "Education"] },
      { icon: Settings, name: "Procurement Consulting & Operations Support", description: "Procurement consulting, operating-model design, process improvement and shared-services execution — driving cost and productivity outcomes.", benefits: ["Higher productivity", "Lower cost-to-serve", "Better SLAs"], industries: ["Manufacturing", "Financial Institutions", "Government"] },
      { icon: MonitorSmartphone, name: "Digital & Business Transformation", description: "Digital transformation, business transformation, technology selection and change delivery to modernise how organisations operate and serve customers.", benefits: ["Modern digital capability", "Better data insights", "Sustainable change adoption"], industries: ["Financial Institutions", "Corporate Organisations", "Government"] },
    ],
    equipment: [
